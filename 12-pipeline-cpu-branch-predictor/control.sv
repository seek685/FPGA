...
module control (
    ...
    always_comb begin
        ...
        case (opcode)
            ...
            LUI: begin // 0 + U-type imm
                reg_write = 1'b1;
                alu_src_a = 2'b10;
                alu_src_b = 1'b1;
                imm_sel   = 3'b011;
            end
            AUIPC: begin // PC + U-type imm
                reg_write = 1'b1;
                alu_src_a = 2'b01;
                alu_src_b = 1'b1;
                imm_sel   = 3'b011;
...
module alu_decoder (
    ...
    always_comb begin
        // LOAD/STORE/LUI/AUIPC do not depend on funct3/funct7_5 
        case (alu_op)
            2'b00: alu_control = 4'b0000; // Address or immediate addition
            2'b01: alu_control = 4'b0001; // BEQ'path; branch_unit makes the decision
            2'b10: begin    // R-type
                case (funct3)
