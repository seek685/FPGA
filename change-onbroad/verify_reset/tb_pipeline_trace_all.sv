...
module tb_pipeline_trace_all;
    ...
    always @(posedge clk) begin
        ...
        if (!rst && ($time >= 4765 && $time <= 4805)) begin
            $display("DBG t=%0t pc=%08h ifid_pc=%08h idex_pc=%08h rdata1=%08h idex_rs1v=%08h fwd1=%08h memwb_v=%b memwb_rd=%0d memwb_m2r=%b memwb_pc4=%08h wb=%08h ra=%08h",
                $time, dut.pc, dut.if_id_pc, dut.id_ex_pc, dut.rdata1,
                dut.id_ex_rs1_value, dut.forwarded_rs1_value, dut.mem_wb_valid,
                dut.mem_wb_rd, dut.mem_wb_MemtoReg, dut.mem_wb_pc4,
                dut.write_back, dut.u_regfile.regs[1]);
        end
